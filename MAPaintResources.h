...
static String  fallback_resources[] = {
  ...
  "MAPaint_EO*domain_name_2:       Moderate Expression",
  ...
  "MAPaint_EO*domain_name_6:       Strong Expression",
  "MAPaint_EO*domain_filename_1:   notExamined.wlz",
  "MAPaint_EO*domain_filename_2:   moderate.wlz",
  ...
  "MAPaint_EO*domain_filename_6:   strong.wlz",
  "MAPaint_EO*numSolidOverlays:    1",
  "MAPaint_EO*numWashOverlays:     5",
  "MAPaint_EO*currentDomain:       6",
  "MAPaint_EO*domain1_red: 	   128",
  "MAPaint_EO*domain1_green:       96",
  "MAPaint_EO*domain1_blue:        0",
  "MAPaint_EO*domain2_red:         255",
  "MAPaint_EO*domain2_green:       255",
  ...
  "MAPaint_EO*domain6_red:         255",
  "MAPaint_EO*domain6_green:       0",
  "MAPaint_EO*domain6_blue:        0",
  "MAPaint_EO*domain1_contrast:    0.25",
  "MAPaint_EO*domain2_contrast:    0.45",
  "MAPaint_EO*domain3_contrast:    0.25",
  "MAPaint_EO*domain4_contrast:    0.25",
  "MAPaint_EO*domain5_contrast:    0.25",
  "MAPaint_EO*domain_priority_1:	1",
  "MAPaint_EO*domain_priority_2:	6",
  "MAPaint_EO*domain_priority_3:	2",
  "MAPaint_EO*domain_priority_4:	3",
  "MAPaint_EO*domain_priority_5:	4",
  "MAPaint_EO*domain_priority_6:	5",
  ...
  "*view_dialog*warp_sgnl_controls_form*pre_process_tab.labelString: Pre-Process",
  ...
  "*view_dialog*warp_sgnl_controls_form*thresh_eccentricity.labelString: Eccentricity",
