...
#else
static char _view_menu_c[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         view_menu.c
  ...
  WlzDVertex3	*fixed)
{
  ...
  XtAddCallback(dialog, XmNhelpCallback, myHGU_XmHelpStandardCb,
  ...
  if( (widget = XtNameToWidget(dialog, "*.help")) != NULL ){
    XtAddCallback(widget, XmNactivateCallback, myHGU_XmHelpStandardCb,
		  "paint/paint.html#view_dialog");
  }
